...
grant references on table "auth"."users" to "anon";

grant select on table "auth"."users" to "anon";

grant trigger on table "auth"."users" to "anon";

grant truncate on table "auth"."users" to "anon";

grant update on table "auth"."users" to "anon";

grant delete on table "auth"."users" to "authenticated";

grant insert on table "auth"."users" to "authenticated";
...
grant truncate on table "auth"."users" to "authenticated";

grant update on table "auth"."users" to "authenticated";
...
create policy "Delete 2ypkqy_0"
on "storage"."objects"
as permissive
for delete
to public
using ((bucket_id = 'transaction-receipts'::text));


create policy "Delete i5g8va_0"
on "storage"."objects"
as permissive
for delete
to public
...
create policy "Delete lmmf47_0"
on "storage"."objects"
as permissive
for delete
to public
using ((bucket_id = 'job-descriptions'::text));


create policy "Insert 2ypkqy_0"
on "storage"."objects"
as permissive
for insert
to public
with check ((bucket_id = 'transaction-receipts'::text));


create policy "Insert i5g8va_0"
on "storage"."objects"
as permissive
for insert
to public
...
create policy "Insert lmmf47_0"
on "storage"."objects"
as permissive
for insert
to public
with check ((bucket_id = 'job-descriptions'::text));


create policy "Select 2ypkqy_0"
on "storage"."objects"
as permissive
for select
to public
